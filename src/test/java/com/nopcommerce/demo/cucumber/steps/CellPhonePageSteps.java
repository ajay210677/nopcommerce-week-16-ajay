...
public class CellPhonePageSteps {
    ...
    public void iFillAllMandatoryFieldOfRegistration() {
        new RegisterPage().enterFirstName("Ajay");
        new RegisterPage().enterLastName("Pandya");
        new RegisterPage().selectDateOfBirth("29");
        new RegisterPage().selectMonthOfBirth("June");
        new RegisterPage().selectYearOfBirth("1977");
    ...
    public void iFillAllMandatoryFieldOnCheckOutPage() {
        new OnePageCheckoutPage().selectCountry("UK");
        new OnePageCheckoutPage().selectState("London");
        new OnePageCheckoutPage().selectCity("Watford");
        new OnePageCheckoutPage().enterAddressLine1("29,Gander ");
        new OnePageCheckoutPage().enterZipCode("wd25 4yr");
        new OnePageCheckoutPage().enterPhoneNumber("1234567891");
    }
    ...
    public void iFillAllVisaCardDetail() {
        ...
        new OnePageCheckoutPage().enterCardNumber("1111111111111111");
        new OnePageCheckoutPage().selectExpiryMonthOfCard("02");
