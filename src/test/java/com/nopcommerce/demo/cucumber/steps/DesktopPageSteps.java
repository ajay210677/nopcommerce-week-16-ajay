...
public class DesktopPageSteps {
    ...
    public void iFillAllMandatoryFieldOnCheckOutAsGuestPage() {
        new OnePageCheckoutPage().enterFirstName("Ajay");
        new OnePageCheckoutPage().enterLastName("Pandya");
        new OnePageCheckoutPage().enterEmail("AjayPandya@gmail.com");
    ...
    public void iFillAllCardDetail() {
        new OnePageCheckoutPage().enterCardHolderName("Mr.Ajay");
        new OnePageCheckoutPage().enterCardNumber("3333 5555 6666 4444");
        new OnePageCheckoutPage().selectExpiryMonthOfCard("06");
